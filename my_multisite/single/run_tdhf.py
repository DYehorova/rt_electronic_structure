...
h_site_single, V_site_single = make_hams.make_ham_single_imp_anderson_realspace( NL, NR, Vg, U, t, Vbias_single, tleads, Full=True  )
...
mf1RDM = hartreefock.interactive_RHF( Nele, h_site_single, V_site_single )
...
#Vbias = 0.001
#Full = False
h_site, V_site = make_hams.make_ham_single_imp_anderson_realspace( NL, NR, Vg, U, t, Vbias_single, tleads, Full=False  )
#h_site, V_site = make_ham.make_ham_multi_imp_anderson_realspace( Ndots, NL, NR, Vg, U, timp, timplead, Vbias, noise, tleads, halfU, boundary, Full)
