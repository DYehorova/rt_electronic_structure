...
def make_ham_multi_imp_anderson_realspace( Nimp, NL, NR, Vg, U, timp, timplead, Vbias, noise, tleads=1.0, halfU=False, boundary=False, Full=False):
...
def make_2D_hubbard( Nx, Ny, Nx_imp, Ny_imp, U, boundary, Full=False ):
    ...
    #to a single impurity cluster, the second Nimp correspond to a second cluster, etc
